...
def main_menu():
    while True:
        ...
        title_text = font.render("Striker's Paradise", True, (0, 0, 0))
        screen.blit(title_text, (SCREEN_WIDTH // 2 - title_text.get_width() // 2, 300))

        one_player_text = small_font.render("Press 1 for 1 Player", True, (0, 0, 0))
        screen.blit(one_player_text, (SCREEN_WIDTH // 2 - one_player_text.get_width() // 2, 400))

        two_player_text = small_font.render("Press 2 for 2 Players", True, (0, 0, 0))
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                pygame.mixer.Sound.play(game_sound)  # Play game sound on key press
...
# Run the main menu and start the game
